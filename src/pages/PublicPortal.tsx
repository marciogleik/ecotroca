...
const PublicPortal: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] font-sans antialiased text-slate-800">
      ...
      {/* ────────────────────── NOTÍCIAS ────────────────────── */}
      <section id="noticias" className="py-16 sm:py-20 bg-white border-y border-slate-200/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto space-y-4 mb-16">
            <span className="text-xs font-bold text-escola tracking-wider uppercase">Últimas Atualizações</span>
            <h2 className="text-3xl sm:text-4xl font-extrabold text-slate-900 tracking-tight">
              Notícias do EcoTroca
            </h2>
            <p className="text-slate-500 font-medium leading-relaxed">
              Acompanhe as novidades, entregas e resultados do programa em nossa comunidade.
            </p>
          </div>
            ...
            <div className="flex flex-col lg:flex-row gap-10 lg:gap-16 items-start">
              ...
              <div className="w-full lg:w-1/2">
                <div className="grid grid-cols-2 gap-3 sm:gap-4">
                  {[1, 2, 3, 4, 5, 6].map((num) => (
                    <div key={num} className="relative rounded-2xl overflow-hidden shadow-sm aspect-[4/3] bg-slate-100">
                      <div className="absolute inset-0 bg-slate-900/10 z-10 hover:bg-transparent transition-colors duration-300"></div>
                      <img 
